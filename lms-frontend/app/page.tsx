      ...
      <div className="max-w-2xl mx-auto text-center px-4">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="bg-white bg-opacity-10 p-6 rounded-lg">
            ...
            <p className="text-indigo-100 text-sm">Learn from industry professionals with real-world experience.</p>
          </div>
          ...
          <div className="bg-white bg-opacity-10 p-6 rounded-lg">
            ...
            <p className="text-indigo-100 text-sm">Engage with dynamic content designed to keep you motivated.</p>
          </div>
          ...
          <div className="bg-white bg-opacity-10 p-6 rounded-lg">
            ...
            <p className="text-indigo-100 text-sm">Join others on the same journey and grow together.</p>
          </div>
        </div>
      </div>
